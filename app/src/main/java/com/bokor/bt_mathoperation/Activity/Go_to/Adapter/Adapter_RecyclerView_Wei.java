...
public class Adapter_RecyclerView_Wei extends RecyclerView.Adapter<Adapter_RecyclerView_Wei.ViewHolder> {

    ArrayList<String> id = new ArrayList<>();
    ArrayList<String> title = new ArrayList<>();
    Context context;

    public Adapter_RecyclerView_Wei(Context applicationContext, ArrayList<String> id, ArrayList<String> title) {
    ...
    @Override
    public Adapter_RecyclerView_Wei.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_for_list, parent, false);

        Adapter_RecyclerView_Wei.ViewHolder viewHolder = new Adapter_RecyclerView_Wei.ViewHolder(view);
