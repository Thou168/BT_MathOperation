...
public class Lets_start_capacity extends AppCompatActivity {
    ImageView img_back,sound;
    ShadowLayout shadowLayout;
    MediaPlayer lesson_capa1,letstart = new MediaPlayer();
    String getSound;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PushDownAnim.setPushDownAnimTo(shadowLayout).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                letStart();
                startActivity(new Intent(Lets_start_capacity.this, Learn_capa_1.class));
                finish();
            }
        });
    ...
    private void sound(){
        stopPlaying();
        lesson_capa1= MediaPlayer.create(this, R.raw.measuring_l_1);
        lesson_capa1.start();
    }

    private void stopPlaying() {
        if (lesson_capa1 != null) {
            lesson_capa1.stop();
            lesson_capa1.release();
            lesson_capa1 = null;
        }
    }
