...
public class Lets_start_mul extends AppCompatActivity {
    ...
    MediaPlayer lesson_mul1,letstart = new MediaPlayer();
    String getSound;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PushDownAnim.setPushDownAnimTo(shadowLayout).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                letStart();
                startActivity(new Intent(Lets_start_mul.this, Learn_Mul_1.class));
                finish();
            }
        });
    ...
    private void sound(){
        stopPlaying();
        lesson_mul1=MediaPlayer.create(this, R.raw.multiplication_1_sipar);
        lesson_mul1.start();
    }
