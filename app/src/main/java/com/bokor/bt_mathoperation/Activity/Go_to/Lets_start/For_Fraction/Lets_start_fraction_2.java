...
public class Lets_start_fraction_2 extends AppCompatActivity {
    ImageView img_back,sound;
    ShadowLayout shadowLayout;
    MediaPlayer lesson_frac2,letstart = new MediaPlayer();
    String getSound;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_lets_start_fraction_1);
        ...
        PushDownAnim.setPushDownAnimTo(shadowLayout).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                letStart();
                startActivity(new Intent(Lets_start_fraction_2.this, Learn_Frac_2.class));
                finish();
            }
        });
    ...
    private void sound(){
        stopPlaying();
        lesson_frac2=MediaPlayer.create(this, R.raw.fraction_2_sipar);
        lesson_frac2.start();
    }

    private void stopPlaying() {
        if (lesson_frac2 != null) {
            lesson_frac2.stop();
            lesson_frac2.release();
            lesson_frac2 = null;
        }
    }
