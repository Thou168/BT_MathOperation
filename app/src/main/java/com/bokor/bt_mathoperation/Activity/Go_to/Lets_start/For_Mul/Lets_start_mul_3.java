...
public class Lets_start_mul_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PushDownAnim.setPushDownAnimTo(shadowLayout).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Lets_start_mul_3.this, Learn_1.class));
            }
        });
    ...
    private void id(){
        ...
        example.setText("ឧទាហរណ៏ ៖ ចន្ថាមានដូង 3 ធ្លាយដែលក្នុងមួយធ្លាយមាន 10 ផ្លែ។ តើដូងទាំងអស់មានប៉ុន្មានផ្លែ? 10 × 3 = ?");
